 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.0-SNAPSHOT-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }</pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/streams-examples-3.2.0-SNAPSHOT-standalone.jar io.confluent.examples.streams.GlobalKTablesExampleDriver
 * }</pre>
 * <p>
