 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.2-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }</pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.2-standalone.jar io.confluent.examples.streams.ApplicationResetExample --reset
 * }</pre>
