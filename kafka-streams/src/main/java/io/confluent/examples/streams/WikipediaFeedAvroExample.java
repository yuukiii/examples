...
/**
 * Computes, for every minute the number of new user feeds from the Wikipedia feed irc
 * stream. Same as {@link WikipediaFeedAvroLambdaExample} but does not use lambda expressions and
 * thus works on Java 7+.
 *
 * Note: The specific Avro binding is used for serialization/deserialization, where the `WikiFeed`
 * class is auto-generated from its Avro schema by the maven avro plugin.  See `wikifeed.avsc` under
 * `src/main/avro/`.
 * 
 * HOW TO RUN THIS EXAMPLE
 *
 * 1) Start Zookeeper, Kafka, and Confluent Schema Registry. Please refer to <a
 * href='http://docs.confluent.io/3.0.0/quickstart.html#quickstart'>QuickStart</a>.
 *
 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.0.0-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExample
 * }
 * </pre>
 *
 ...
 * $ java -cp target/streams-examples-3.0.0-standalone.jar io.confluent.examples.streams .WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
