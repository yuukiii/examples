 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.1.0-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }</pre>
 ...
 * $ java -cp target/streams-examples-3.1.0-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }</pre>
 */
