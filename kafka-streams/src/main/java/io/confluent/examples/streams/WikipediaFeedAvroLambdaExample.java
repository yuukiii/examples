 ...
 * href='http://docs.confluent.io/3.0.1/quickstart.html#quickstart'>QuickStart </a>.
 *
 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.0.1-standalone.jar io.confluent.examples.streams
 ...
 * $ java -cp target/streams-examples-3.0.1-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
...
public class WikipediaFeedAvroLambdaExample {
  ...
  public static void main(String[] args) throws Exception {
    KafkaStreams streams = buildWikipediaFeed("localhost:9092", "localhost:2181",
                                              "http://localhost:8081", "/tmp/kafka-streams");
    streams.start();
