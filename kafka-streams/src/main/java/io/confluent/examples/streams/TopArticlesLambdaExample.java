 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.2-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }</pre>
 ...
 * $ java -cp target/streams-examples-3.2.2-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }</pre>
 */
