 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.0.1-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 *
 ...
 * $ java -cp target/streams-examples-3.0.1-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
 *
