...
/**
 * Demonstrates how to use `reduceByKey` to sum numbers. See {@code SumLambdaIntegrationTest} for an
 * end-to-end example.
 * <p>
 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.0.1-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }</pre>
