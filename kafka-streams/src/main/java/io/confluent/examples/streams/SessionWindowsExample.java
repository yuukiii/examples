 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.2.0-SNAPSHOT-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }</pre>
 ...
 * $ java -cp target/streams-examples-3.2.0-SNAPSHOT-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }</pre>
