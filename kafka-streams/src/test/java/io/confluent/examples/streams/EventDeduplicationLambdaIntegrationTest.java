 ...
 *
 * IMPORTANT:  Since Kafka 0.11, the Kafka Streams API supports exactly-once processing semantics.
 * With this feature available, most use cases will no longer need to worry about duplicates or
 * duplicate processing because, typically, such duplicates only happen in the face of failures.
