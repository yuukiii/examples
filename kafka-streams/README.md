...
dependencies {
    compile "org.apache.kafka:kafka-streams:0.10.1.0-cp2"
    compile "org.apache.kafka:kafka-clients:0.10.1.0-cp2"
}
```
...
| [3.1.x](../../../tree/3.1.x/kafka-streams)                                     | 0.10.1.0(-cp2)    | 3.1.1              | Works out of the box                                                                  |
